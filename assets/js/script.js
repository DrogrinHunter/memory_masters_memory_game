...
const cardDeck = ["aurelia.svg", "backbone.svg", "ember.svg", "react.svg", "vue.svg", "html.svg", "css.svg", "js-badge.svg", ];
...
class BoardGame {
	...
	constructor(totalTime) {
		...
		this.mainGameboard = document.getElementById("main-gameboard");
		this.addListeners();
	}
	/**
	...
	addListeners() {
		...
		window.addEventListener('resize', _.debounce(this.onResizeWindow.bind(this), 150));
	}
	/**
	...
	onResizeWindow() {
		...
		this.mainGameboard.style.width = (value - 120) + 'px'; // 120 is the space occuped by the navbar + margins
	}
	/**
